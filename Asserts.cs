...
namespace Syntaxes
{
    class Asserts
    {
        ...
        public void IsNull()
        {
            ...
            // Constraint Syntax: Assert.That | Is. |Has. | Does.
        ...
        /*
             . => current position, start of an new regular expression
             * => zero or more characters
             + => one or more characters
             ? => Single character
             ^ => Verify from begining of a string
             $ => End of line
             d => numbers
             W => words
            [] => range

        Eg: abc@gmail.com => [a-z]+[0-9]*@[a-z]+[0-9]*.com
         */
